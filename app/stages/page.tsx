export default function Stages() {
  ...
  reservees: 0,
  couleur: '#0066CC',
  strategie: 'Jour 1-2: Adaptation eau et confiance / Jour 3-4: Apprentissage techniques de nage / Jour 5-6: Perfectionnement et autonomie',
},
    {
  ville: 'Saly et Mbour',
  emoji: '🏖️',
  lieu: 'Piscine partenaire AVAMOUSSA + Plage de Mbour',
  prix: '60 000 FCFA',
  ...
  reservees: 0,
  couleur: '#FF6B00',
  strategie: 'Jour 1: Theorie et objectifs / Jour 2: Adaptation eau et flottaison / Jour 3: Deplacements et respiration / Jour 4: Technique crawl / Jour 5: Perfectionnement / Jour 6: Application en mer et validation',
},
    {
  ville: 'Thies',
  emoji: '🏙️',
