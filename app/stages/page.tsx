export default function Stages() {
  ...
  const formations = [
    { titre: 'Coaching Prive', emoji: '⭐', desc: 'Coaching personnalise a domicile ou a la piscine. Suivi individuel VIP avec la Methode AVAMOUSSA Elite x Malcolm.', prix: 'Sur devis', seances: 'Selon objectif', places: 1 },
    { titre: 'Stage Prive', emoji: '🏊', desc: 'Formation en petit groupe sans publication sur les reseaux sociaux. Ideal pour rester discret.', prix: 'Sur devis', seances: '6 seances', places: 10 },
    { titre: 'Stage Promo', emoji: '🎯', desc: 'Formation en groupe avec publication des videos sur TikTok et Instagram AVAMOUSSA. Rejoins la communaute.', prix: '35 000 FCFA', seances: '6 seances', places: 20 },
